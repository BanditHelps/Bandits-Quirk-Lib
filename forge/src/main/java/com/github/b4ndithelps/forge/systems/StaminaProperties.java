...
//                    .configurable("Amount of stamina this ability consumes per tick when active");
    ...
    public static final PalladiumProperty<Integer> STAMINA_COST = (new IntegerProperty("stamina_cost")).configurable("Determines the stamina cost for using this ability");
