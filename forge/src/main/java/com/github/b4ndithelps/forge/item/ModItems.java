...
public class ModItems {
    ...
    public static final RegistryObject<Item> TIER1_TRIGGER = ITEMS.register("trigger_tier1",
            () -> new Item(new Item.Properties().stacksTo(1).rarity(Rarity.RARE)) {
                ...
                public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
                    tooltipComponents.add(Component.translatable("tooltip.bandits_quirk_lib.tier1_trigger").withStyle(net.minecraft.ChatFormatting.GRAY));
    ...
    public static final RegistryObject<Item> TIER2_TRIGGER = ITEMS.register("trigger_tier2",
            () -> new Item(new Item.Properties().stacksTo(1).rarity(Rarity.RARE)) {
                @Override
                public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
                    tooltipComponents.add(Component.translatable("tooltip.bandits_quirk_lib.tier2_trigger").withStyle(net.minecraft.ChatFormatting.GRAY));
                    super.appendHoverText(stack, level, tooltipComponents, isAdvanced);
                }
            });
    ...
    public static final RegistryObject<Item> TIER3_TRIGGER = ITEMS.register("trigger_tier3",
            () -> new Item(new Item.Properties().stacksTo(1).rarity(Rarity.RARE)) {
                @Override
                public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
                    tooltipComponents.add(Component.translatable("tooltip.bandits_quirk_lib.tier3_trigger").withStyle(net.minecraft.ChatFormatting.GRAY));
                    super.appendHoverText(stack, level, tooltipComponents, isAdvanced);
                }
            });
