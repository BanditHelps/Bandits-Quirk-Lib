...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BIO_TERMINAL_REF = registerBlock("bio_terminal_ref", () -> new BioTerminalRefBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(3.0F, 6.0F).sound(SoundType.METAL).noOcclusion()));
