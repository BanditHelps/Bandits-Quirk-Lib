...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> GENE_SLICER = registerBlock("gene_slicer", () -> new GeneSlicerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(3.0F, 6.0F).sound(SoundType.METAL).noOcclusion()));
    ...
    public static final RegistryObject<Block> PERMAFROST_ICE = registerBlock("permafrost_ice",
            () -> new PermafrostIceBlock(BlockBehaviour.Properties.copy(Blocks.ICE)));
